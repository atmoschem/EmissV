...
- added support for EDGAR, EDGAR_HTAPv2, GAINS, RCP, MACCITY, FFDAS,
  ODIAC, VULCAN and ACES inventories in read()

## EmissV 0.665.3.0 (2020-12-11)

CRAN release: 2020-10-08

- Removing the warning (due to Migration to PROJ6/GDAL3) on read()
  changing all “+proj=longlat +ellps=GRS80 +no_defs” tp “+proj=longlat”
...
- lineSource updates: faster, new options for grid generation and
  support for variables and length
...
- read has speciation integated to split emissions into different
  species
- read has coef to merge different inputs to one specie
- new temporal profiles ‘data(perfil)’ for sectors from Oliver et
  al. (2003)
...
- fix [\#20](https://github.com/atmoschem/EmissV/issues/20)
...
- lineSource is faster, uses sf and data.table instead of several
  packages
...
- exemples tested, with the eception of plots and read (no extra data
  added)
